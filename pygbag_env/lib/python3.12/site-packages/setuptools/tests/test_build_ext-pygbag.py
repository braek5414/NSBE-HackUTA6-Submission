...
class TestBuildExt:
    ...
    def test_get_outputs(self, tmpdir_cwd, monkeypatch):
        ...
        assert outputs == [
            f"{build_lib}/ext3.ogg",
            f"{build_lib}/mypkg/ext1.ogg",
            f"{build_lib}/mypkg/subpkg/ext2.ogg",
        ]
        ...
        assert mapping == {
            f"{build_lib}/ext3.ogg": "src/ext3.ogg",
            f"{build_lib}/mypkg/ext1.ogg": "src/mypkg/ext1.ogg",
            f"{build_lib}/mypkg/subpkg/ext2.ogg": "src/mypkg/subpkg/ext2.ogg",
        }
